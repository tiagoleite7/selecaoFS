...
namespace FI.AtividadeEntrevista.DAL
{
    ...
    internal class DaoCliente : AcessoDados
    {
        ...
        internal long Incluir(DML.Cliente cliente)
        {
            ...
            DataSet ds = base.Consultar("FI_SP_IncCliente_V2", parametros);
            long ret = 0;
        ...
        internal DML.Cliente Consultar(long Id)
        {
            ...
            DataSet ds = base.Consultar("FI_SP_ConsCliente_V2", parametros);
        ...
        internal List<Cliente> Pesquisa(int iniciarEm, int quantidade, string campoOrdenacao, bool crescente, out int qtd)
        {
            ...
            DataSet ds = base.Consultar("FI_SP_PesqCliente_V2", parametros);
            List<DML.Cliente> cli = Converter(ds);
        ...
        internal void Alterar(DML.Cliente cliente)
        {
            ...
            base.Executar("FI_SP_AltCliente_V2", parametros);
        }
        ...
        internal void Excluir(long Id)
        {
            ...
            base.Executar("FI_SP_DelCliente_V2", parametros);
        }
